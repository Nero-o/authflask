...
from ..controllers.card_controller import get_cards, create_pipefy_cards, approve_cards, get_card_by_id, get_approved_card_by_id
...
@card_bp.route('/pipefy/get_approved_cards/<int:card_id>', methods=['GET'])
def handle_get_approve_cards(card_id):
    return get_approved_card_by_id(card_id)
